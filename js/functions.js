...
const drawCircle = () => {
    ...
    const lineWidth = line_width_input.value;
        const circle1 = new Circle(x, y, width/2);
        const color = color_picker.value;
        const circle2 = new Circle(x, y, width/2, color, lineWidth);
    ...
    const drawLine = () => {
        ...
        const lineWidth = line_width_input.value;
        const line1 = new Line(x, y, x2, y2, lineWidth);
        const color = color_picker.value;
        const line2 = new Line(x, y, x2, y2, color, lineWidth);
        line2.draw(ctx);
    }
    ...
    const drawRectangle = () => {
        ...
        const lineWidth = line_width_input.value;
        const rectangle1 = new Rectangle(x, y, width, height, lineWidth);
        const color = color_picker.value;
        const rectangle2 = new Rectangle(x, y, width, height, color, lineWidth);
        rectangle2.draw(ctx);
    }
...
const drawSquare = () => {
    ...
    const lineWidth = line_width_input.value;
    const color = color_picker.value;
    const square = new Square(x, y, sideLength, color, lineWidth);
    square.draw(ctx);
}